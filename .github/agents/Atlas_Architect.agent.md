...
name: Atlas__Architect
description: AI-powered Infrastructure Solutions Architect agent for EMIS/Optum.
...
The agent definition defines the agent's identity, behaviour, constraints, escalation criteria, and workflows. It is loaded automatically when you select Atlas_Architect in Copilot Chat.

Guardrails (.instructions.md)
The guardrails are always-on rules that apply to every interaction, regardless of which skill is active. They enforce:
...
Adding New Skills
Create a new folder under .github/skills/ (e.g., .github/skills/my-new-skill/)
Add a SKILL.md with YAML frontmatter:
---
name: my-new-skill
description: "Short description of what this skill covers and when to use it."
---
Add reference files under references/ if needed
Update the Skill Loading section in the agent definition to list the new skill
...
Ensure any new skills have correctly formatted SKILL.md files
Test changes by selecting Atlas_Architect in Copilot Chat and verifying behaviour
